...
class VideoService {
  static Future<List<VideoModel>> getFeed({
    ...
    final params = {
      ...
      // Backend usa 'q' para pesquisa, não 'pesquisa'
  ...
  static Future<bool> toggleLike(String videoId, String token) async {
    ...
    final data = jsonDecode(response.body) as Map<String, dynamic>;
    // Backend retorna 'liked', não 'gostou'
  ...
  static Future<List<CommentModel>> getComentarios(String videoId) async {
    ...
    // Backend retorna array direto, não { comentarios: [] }
  ...
  static Future<VideoModel> uploadVideo({
    ...
    // Backend espera 'termoAceite', não 'termos'
    request.fields['termoAceite'] = termos.toString();
    if (latitude != null) request.fields['latitude'] = latitude.toString();
    if (longitude != null) request.fields['longitude'] = longitude.toString();

    // Forçar MIME type explícito — Android às vezes envia application/octet-stream
